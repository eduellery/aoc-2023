...
let day03test1 = day03part1(input: getInput(path: "test/day03.test"))
assert(day03test1 == 4361)
let day03Part1 = day03part1(input: getInput(path: "test/day03.in"))
assert(day03Part1 == 546312)
print("Day 03 - part 1: \(day03Part1)")
let day03test2 = day03part2(input: getInput(path: "test/day03.test"))
assert(day03test2 == 467835)
let day03Part2 = day03part2(input: getInput(path: "test/day03.in"))
assert(day03Part2 == 87449461)
print("Day 03 - part 2: \(day03Part2)")